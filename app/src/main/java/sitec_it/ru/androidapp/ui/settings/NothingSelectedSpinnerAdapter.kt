...
class NothingSelectedSpinnerAdapter(
    ...
    protected var nothingSelectedDropdownLayout: Int = -1
     ...
     * @param context
     */
    /*fun NothingSelectedSpinnerAdapter(
    ...
    /*fun NothingSelectedSpinnerAdapter(
        spinnerAdapter: SpinnerAdapter?,
        nothingSelectedLayout: Int, nothingSelectedDropdownLayout: Int, context: Context?
    ) {
